            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('references.update', $reference->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($reference->logo)
                            <div class="mt-2">
                                <img src="{{ asset($reference->logo) }}" alt="{{ $reference->name }} Logo" class="img-thumbnail" style="width: 100px;">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="note" id="note" class="form-control" rows="4">{{ old('note', $reference->note) }}</textarea>
                    </div>
